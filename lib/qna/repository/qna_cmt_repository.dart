...
part 'qna_cmt_repository.g.dart';

final qnaCommentRepositoryProvider = Provider((ref) {
  final url = '$baseUrl/comment/qna';
  final dio = ref.watch(dioProvider);
  final repository = QnaCommentRepository(dio, baseUrl: url);
  return repository;
});

@RestApi()
abstract class QnaCommentRepository {
  factory QnaCommentRepository(Dio dio, {String baseUrl}) =
      _QnaCommentRepository;
